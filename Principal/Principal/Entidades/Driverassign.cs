...
namespace Principal.Entidades
{
    class Driverassign
    {
        ...
        static string Entity = "driverassigns";
        private string _id, _iddriver, _idvehicle, _dateassigned, _createdAt, _updatedAt;
        bool _active;
        #endregion

        #region Propiedades publicas
        public string Iddriver { get => _iddriver; set => _iddriver = value; }
